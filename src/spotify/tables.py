...
class SavedSpotifyLinkTable(tables.Table):
    cover = TemplateColumn(
        template_name="app/saved_spotify_link/tables/saved_spotify_links_cover_column.html",
        orderable=False,
    )
    link = TemplateColumn(
        verbose_name=_("Link"),
        template_name="app/saved_spotify_link/tables/saved_spotify_links_link_column.html",
        orderable=False,
    )
    ...
    genres = TemplateColumn(
        template_name="app/saved_spotify_link/tables/saved_spotify_links_genres_column.html",
        orderable=False,
    )
    actions = TemplateColumn(
        template_name="app/saved_spotify_link/tables/saved_spotify_links_actions_column.html",
        orderable=False,
    )
...
class FollowedArtistTable(tables.Table):
    photo = TemplateColumn(
        template_name="app/followed_artist/tables/followed_artist_photo_column.html",
        orderable=False,
    )
    genres = TemplateColumn(
        template_name="app/followed_artist/tables/followed_artist_genres_column.html",
        orderable=False,
    )
