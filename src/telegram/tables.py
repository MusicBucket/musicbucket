...
class SentSpotifyLinkTable(tables.Table):
    cover = TemplateColumn(
        template_name="telegram/tables/sent_spotify_links_cover_column.html",
        orderable=False,
    )
    link = TemplateColumn(
        verbose_name=_("Link"),
        template_name="telegram/tables/sent_spotify_links_link_column.html",
        orderable=False,
    )
    spotify_url = TemplateColumn(
        verbose_name=_("Spotify"),
        template_name="telegram/tables/sent_spotify_links_spotify_url_column.html",
        orderable=False,
    )
