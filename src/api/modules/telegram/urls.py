...
urlpatterns = [
    path(
        "users/", views.TelegramUserListCreateAPIView.as_view(), name="user-list-create"
    ),
    path(
    ...
    path(
        "chats/", views.TelegramChatListCreateAPIView.as_view(), name="chat-list-create"
    ),
    path(
    ...
    path("stats/<str:chat__telegram_id>/", views.StatsAPIView.as_view(), name="stats"),
]
