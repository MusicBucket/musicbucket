...
from api.modules.spotify.bot.filters import SavedSpotifyLinkFilter, FollowedArtistFilter
...
class SavedSpotifyLinkRetrieveUpdateDestroyAPIView(
...
class FollowedArtistCheckNewMusicReleases(generics.ListAPIView):
    ...
    def _update_followed_artists_albums(followed_artists_qs):
        ...
        for followed_artist in followed_artists_qs:
            spotify_artist_albums = spotify_client.get_all_artist_albums(
